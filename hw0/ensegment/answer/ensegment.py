...
class Segment:
    ...
    def __init__(self, Pw, logsum=True):
        self.Pw = Pw
        self.logsum=logsum
    ...
    def Pwords(self, words): 
        ...
        if self.logsum:
            return reduce_sum(log10(self.Pw(w)) for w in words)    
...
if __name__ == '__main__':
    ...
    Pw = Pdist(data=datafile(opts.counts1w), missingfn=(lambda k, N: 10.0/(N * 10**len(k))))
